...
const teamsByRegion = {
  EU: [
    {
      name: "HEROIC",
      logo: "./src/assets/fotos-times/heroic-red-outline.png",
    ...
    {
      name: "TEAM FALCONS",
      logo: "./src/assets/fotos-times/Team-Falcons.png",
    ...
    {
      name: "ETERNAL FIRE",
      logo: "./src/assets/fotos-times/Eternal-Fire.png",
    ...
    {
      name: "3DMAX",
      logo: "./src/assets/fotos-times/3DMAX.png",
    ...
    {
      name: "OG",
      logo: "./src/assets/fotos-times/OG-300x300-1.png",
    ...
    {
      name: "FNATIC",
      logo: "./src/assets/fotos-times/fnatic.png",
      description: "A Fnatic é uma organização de eSports histórica, fundada em 2004 no Reino Unido, e uma das pioneiras no cenário de Counter-Strike. Desde os primeiros dias do CS, a Fnatic estabeleceu seu legado ao conquistar diversos campeonatos e, em 2015, se tornou uma das primeiras equipes a vencer três Majors de CS. Conhecida por promover grandes talentos suecos e internacionais, a organização é responsável por revelar alguns dos maiores jogadores da história do jogo.",
        ...
        {
      name: "CLOUD9",
      logo: "./src/assets/fotos-times/cloud9.png",
    ...
    {
      name: "B8",
      logo: "./src/assets/fotos-times/B8_Logo_white.png",
  ...
  NA: [
    ...
    {
      name: "TEAM LIQUID",
      logo: "./src/assets/fotos-times/team-liquid-2.png",
    ...
    {
      name: "LEGACY",
      logo: "./src/assets/fotos-times/Legacy.png",
    ...
    },
    {
      ...
      logo: "./src/assets/fotos-times/Party-Astronauts.png",
    ...
    {
      name: "LAG GAMING",
      logo: "./src/assets/fotos-times/LAG-Gaming.png",
  ...
  SA: [
    {
      name: "MIBR",
      logo: "./src/assets/fotos-times/MIBR.png",
    ...
    {
      name: "PAIN GAMING",
      logo: "./src/assets/fotos-times/pain-gaming.png",
    ...
    {
      name: "RED CANIDS",
      logo: "./src/assets/fotos-times/RED-Canids.png",
    ...
    {
      name: "IMPERIAL",
      logo: "./src/assets/fotos-times/Imperial-Sportsbet.png",
  ...
  ASIA: [
    {
      name: "TYLOO",
      logo: "./src/assets/fotos-times/TYLOO.png",
    ...
    {
      name: "ATOX",
      logo: "./src/assets/fotos-times/ATOX-1.png",
    ...
    {
      name: "RARE ATOM",
      logo: "./src/assets/fotos-times/rare-atom.png",
    ...
    {
      name: "CATEVIL",
      logo: "./src/assets/fotos-times/CatEvil.png",
